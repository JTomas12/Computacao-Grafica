...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.addColor(this.scene, 'globalAmbientLight', this.scene.globalAmbientLight).name('Global Ambient Light').onChange(value => {
            this.scene.setGlobalAmbientLight(...value);
        });
