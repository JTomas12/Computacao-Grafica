    ...
    createGarden() {
        for (let i = 0; i < this.rows; i++) {
            for (let j = 0; j < this.cols; j++) {
                ...
                const outer_radius = 1 + Math.random() * 0.2; // Raio externo das pétalas entre 1 e 1.2
                ...
                const stem_radius = 0.1 + Math.random() * 0.03 ; // Raio do caule entre 0.1 e 0.13
                ...
                const stem_height = 1.5 + Math.random() * 0.5; // Altura do caule entre 1.5 e 2
                ...
                const rotationAngle = -0.76 + Math.random()  // Ângulo de rotação das pétalas entre -0.76 e 0.76
                const prismAngle = -3.14 // Ângulo de rotação do prisma
                ...
                this.flowers.push({flower, x, z}); // Adiciona a flor ao jardim
            }
        }
    }
